...
print(sprintf("The maximum number of views for a video with zero likes is %.0f views", max(lab2_df[lab2_df$likes==0,"views"], na.rm = TRUE)))
print(sprintf("The 99th percentile video (in terms of views) has %.0f views",quantile(lab2_df[lab2_df$likes==0,"views"], na.rm = T, probs = c(0.99))))
```
...
#histograms of words
```{r}
lHist<-ggplot(data=lab2_df, aes(x=words))+
...
```{r}
lnlHist<-ggplot(data=lab2_df, aes(x=log(words)))+
...
```{r}
print(sprintf("%.0f videos are longer than 8 words.", sum(lab2_df$words > 8, na.rm = TRUE)))
print(sprintf("%.1f percent of videos are longer than 8 words.",100.0*sum(lab2_df$words > 8, na.rm = TRUE)))

print("")
print(sprintf("The median number of views for videos over 8 words is %.0f,  words.",100.0*sum(lab2_df$words > 8, na.rm = TRUE)))
```
#
```{r}
print(sprintf("The median number of views for 0-1 word title videos is %.0f",median(lab2_df[lab2_df$words <=1, "views"],na.rm=TRUE)))
print(sprintf("The median number of views for 1-2 word title videos is %.0f",median(lab2_df[lab2_df$words == 1 | lab2_df$words == 2, "views"],na.rm=TRUE)))
print(sprintf("The median number of views for 3-4 word title videos is %.0f",median(lab2_df[lab2_df$words == 3 | lab2_df$words == 4, "views"],na.rm=TRUE)))
print(sprintf("The median number of views for 5-6 word title videos is %.0f",median(lab2_df[lab2_df$words == 5 | lab2_df$words == 6, "views"],na.rm=TRUE)))
print(sprintf("The median number of views for 7-8 word title videos is %.0f",median(lab2_df[lab2_df$words == 7 | lab2_df$words == 8, "views"],na.rm=TRUE)))
print(sprintf("The median number of views for 9-10 word title videos is %.0f",median(lab2_df[lab2_df$words == 9 | lab2_df$words == 10, "views"],na.rm=TRUE)))
print(sprintf("The median number of views for 11-12 word title videos is %.0f",median(lab2_df[lab2_df$words == 11 | lab2_df$words == 12, "views"],na.rm=TRUE)))
print(sprintf("The median number of views for videos with 24+ word title is %.0f",median(lab2_df[lab2_df$words >= 24, "views"],na.rm=TRUE)))
```
...
print(sprintf("The mean words is %.2f words", mean(lab2_df$words, na.rm=TRUE)/60))
print(sprintf("The median words is %.2f words", median(lab2_df$words,na.rm=TRUE)/60))
```
# remove NAS
```{r}
...
```{r}
lab2_df[lab2_df$likes == 0, "likes"] <- mean_Likes
dim(lab2_df)
```
